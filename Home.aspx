<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="KPATEL_Home" %>
        ...
        <div id="second">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Registration.aspx"
                                Style="color: #ff0000">New User ??</asp:HyperLink>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
            ...
            <div id="slide">
                <div id="wowslider-container1">
                    <div class="ws_images">
                        <a href="PRODUCT.aspx">
                            <img src="data1/images/1.jpg" alt="1" title="Online Shoes" id="wows0" onclick="return wows0_onclick()" /></a>
                        <a href="#">
                            <img src="data1/images/2.jpg" alt="2" title="Ladies Sendal" id="wows1" /></a>
                        <a href="#">
                            <img src="data1/images/3.jpg" alt="3" title="Shoes Variety" id="wows2" /></a>
                        <a href="#">
                            <img src="data1/images/4.jpg" alt="4" title="Buy online Shoes" id="wows3" /></a>
                        <a href="#">
                            <img src="data1/images/5.jpg" alt="5" title="Best Sendal" id="wows4" /></a>
                        <a href="#">
                            <img src="data1/images/6.jpg" alt="6" title="Online Shoes" id="wows5" /></a>
                    </div>
                    <div class="ws_bullets">
                        <div>
                            <a href="#wows0" title="1">
                                <img src="data1/tooltips/1.jpg" alt="1" />1</a>
                            <a href="#wows1" title="2">
                                <img src="data1/tooltips/2.jpg" alt="2" />2</a>
                            <a href="#wows2" title="3">
                                <img src="data1/tooltips/3.jpg" alt="3" />3</a>
                            <a href="#wows3" title="4">
                                <img src="data1/tooltips/4.jpg" alt="4" />4</a>
                            <a href="#wows4" title="5">
                                <img src="data1/tooltips/5.jpg" alt="5" />5</a>
                            <a href="#wows5" title="6">
                                <img src="data1/tooltips/6.jpg" alt="6" />6</a>
                        </div>
                    </div>
                        ...
                        <td>
                            <table class="tbl">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="Button2" runat="server" Text="Search" OnClick="Button2_Click" Style="background-color: #ff0000 ; color:white"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td align="center">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" Text='<%#Eval("Cname") %>' CssClass="cgrid" ForeColor="Black" ID="lnkcate" CommandName="cate" CommandArgument='<%#Eval("Cname") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
